...
<div class="col-sm-6 mb-1 p-2">
  <form action="{{ url('/akun/pendaftaran') }}" method="post">
    ...
    <div class="form-floating mb-2">
      <input type="text" class="form-control @error('id_user') is-invalid @enderror" name="id_user" value="{{ old('id_user') }}" placeholder="No KTP" onkeypress="return isNumber(event)" maxlength="16"> 
    ...
    <div class="form-floating mb-2">
      <input type="text" class="form-control @error('name_user') is-invalid @enderror" name="name_user" value="{{ old('name_user') }}" placeholder="Username"> 
    ...
    <div class="form-floating mb-2">
      <input type="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror" value="{{ old('alamat') }}" placeholder="Email"> 
